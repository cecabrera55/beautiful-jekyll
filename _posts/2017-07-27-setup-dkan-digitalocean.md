...
No soy un _sysadmin_. Muchos de los trucos en este tutorial fueron aprendidos en Google por lo que deben haber maneras más eficientes de realizar la misma tarea. Si tienes comentarios sobre este tutorial, me gustaría [escucharlos]({{ site.url }}/aboutme#contact).
